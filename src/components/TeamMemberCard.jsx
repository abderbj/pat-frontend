...
export default function TeamMemberCard({teamMemberData,setSelectedTeamMember}){
    ...
    return(
        <Card variant='outlined' sx={{maxWidth:262,borderRadius:3,padding:2}} onClick={setSelectedTeamMember}>
            ...
            <CardContent sx={{textAlign:'center'}}>
                ...
                <Typography variant="subtitle1" component="div" sx={{color:'#202224'}}>{teamMemberData.post}</Typography>
