...
import TeaamMemberProfile from '../components/TeamMemberProfile';
    ...
    return (
        <Box bgcolor={"#F5F6FA"}>
            ...
            {team.selectedTeamMember === -1 ?
                ...
                <TeaamMemberProfile onDelete={deleteTeamMember} teamMemberData={findTeamMemberById(team.selectedTeamMember)} />
            }
        </Box>
    );
}
